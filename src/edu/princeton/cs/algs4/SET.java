...
public class SET<Key extends Comparable<Key>> implements Iterable<Key> {
  ...
  public static void main(String[] args) {
    ...
    StdOut
        .println("floor(www.simpsonr.com) = " + set.floor("www.simpsonr.com"));
    StdOut
        .println("floor(www.simpsons.com) = " + set.floor("www.simpsons.com"));
    StdOut
        .println("floor(www.simpsont.com) = " + set.floor("www.simpsont.com"));
    StdOut.println();
